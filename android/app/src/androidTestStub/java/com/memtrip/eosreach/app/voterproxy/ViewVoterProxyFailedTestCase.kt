...
class ViewVoterProxyFailedTestCase : StubTestCase() {
    ...
    override fun test() {
        ...
        voteRobot
            ...
            .selectProxyVoteItem()
        proxyVoterRobot
            .verifyProxyVoterErrorScreen()
            .selectProxyVoterRetryButton()
            .verifyProxyVoterScreen()
    }

    override fun stubApi(): StubApi = object : StubApi(context()) {

        private val proxyVoterJsonRequest = ChainedStubRequest(BasicStubRequest(400))
        ...
        override fun getAccount(): Stub = Stub(
            ...
            BasicStubRequest(200, {
                readJsonFile("stub/happypath/happy_path_get_account_voter_info_proxy_vote.json")
            })
        )

        override fun getTableRowsSingleProxyVoter(): Stub = Stub(
            StubMatcher(
                context.getString(R.string.app_default_eos_endpoint_root),
                Regex("v1/chain/get_table_rows$"),
                readJsonFile("stub/request/request_get_table_rows_regproxyinfo_single.json")
            ),
            proxyVoterJsonRequest
        )
    }
}
