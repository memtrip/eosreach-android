...
class ViewBlockProducerFailedTestCase : StubTestCase() {
    ...
    override fun test() {
        ...
        blockProducerRobot
            .selectViewBlockProducerErrorRetryButton()
            .verifyViewBlockProducerInformationScreen(
                "AcroEOS",
                "https://acroeos.one",
                "community@acroeos.io")
    }

    override fun stubApi(): StubApi = object : StubApi(context()) {

        private val blockProducerJsonRequest = ChainedStubRequest(BasicStubRequest(400))
