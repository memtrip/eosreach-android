...
class ManageBandwidthRendererTest : Spek({
    ...
    val layout by memoized { mock<ManageBandwidthViewLayout>() }
    ...
    given("a ManageBandwidthRenderer") {
        ...
        on("ViewState is not initialized") {
            renderer.layout(layout, ManageBandwidthViewState(ManageBandwidthViewState.View.OnProgress))
        ...
        on("ViewState is initialized") {
            renderer.layout(layout, ManageBandwidthViewState(ManageBandwidthViewState.View.OnError))
